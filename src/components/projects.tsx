...
const Card = ({ title, image, tagline }: Project) => {
  ...
  return (
    ...
    >
      ...
      <div className="md:py-8 relative">
        ...
        <div className="overflow-hidden max-md:hidden">
          <motion.p
            ...
            className="absolute text-white/50 line-clamp-2"
          >
            {tagline}
          </motion.p>
        </div>
      ...
      <Image
        ...
        height={500}
        alt={title}
        className="object-cover mt-3 h-full w-full object-left rounded-xl md:rounded-t-3xl"
      />
    </motion.div>
  );
};
